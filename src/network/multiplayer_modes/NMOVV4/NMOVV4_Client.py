...
class NMOVV4Client(NetWorkMultiplayerClient):
    def __init__(self, Game, Arena_ID: int, client, PINFS):
        super().__init__(Game, Arena_ID, MMode.OVV4, client, PINFS)

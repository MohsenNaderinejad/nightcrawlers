...
class NMOVV2Server(NetWorkMultiplayerServer):
    def __init__(self, Arena_ID: int, PINFS, P1_CONN, P2_CONN):
        super().__init__(Arena_ID, MMode.OVV2, PINFS)
        ...
        self.str_match_end = f"{self.P1.name}/{self.P1.hashtag} vs {self.P2.name}/{self.P2.hashtag}"
